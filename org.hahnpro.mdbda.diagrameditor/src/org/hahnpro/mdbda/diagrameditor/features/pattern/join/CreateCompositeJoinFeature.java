...
public class CreateCompositeJoinFeature extends CreatePatternFeature implements
		ICreateFeature {
	public static String name = "Composite Join";
	public static String description = "Creates a new composite join pattern";
    
    
	public CreateCompositeJoinFeature(IFeatureProvider fp) {
	...
	public Object[] create(ICreateContext context) {
		...
		CompositeJoin eInst = JoinFactory.eINSTANCE.createCompositeJoin();
