...
public class LayoutResourceFeature extends AbstractLayoutFeature {

	public LayoutResourceFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
	       ...
	       if (!(pe instanceof ContainerShape))
	           return false;
	       return  getBusinessObjectForPictogramElement(pe) instanceof Resource;
	}
